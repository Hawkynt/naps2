...
namespace NAPS2.WinForms {
  public partial class FOcrSetup : FormBase {
    ...
    protected override void OnLoad(object sender, EventArgs eventArgs) {
      ...
      var ocrLanguageCode = this.UserConfigManager.Config.OcrLanguageCode;
      if (ocrLanguageCode == null) {
        comboLanguages.SelectedItem = comboLanguages.Items[0];
      } else {
        comboLanguages.SelectedValue = ocrLanguageCode;
